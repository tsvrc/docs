      ...
      <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-center gap-4 px-6 py-4">
        <a href="https://github.com/tsvrc/tsvrc-core" className="opacity-90 hover:opacity-100">
          <img
            ...
            alt="GitHub stars for tsvrc/tsvrc-core"
            height={20}
          />
        </a>
        <a href="https://github.com/tsvrc/tsvrc-core/commits/main" className="opacity-90 hover:opacity-100">
          <img
            ...
            alt="Last commit to tsvrc/tsvrc-core"
            height={20}
          />
        </a>
...
function Projects() {
  return (
    <section className="mx-auto max-w-4xl px-6 py-16">
      <h2 className="font-heading text-2xl font-semibold text-fg">Projects</h2>
      <p className="mt-2 max-w-2xl text-fg-muted">
        Every TsVRC project lives on this one site. See why in{' '}
        <Link to="/docs/tsvrc/intro#this-site" className="text-accent no-underline hover:underline">
          the intro
        </Link>
        . Just one so far; more will land here as they ship.
      </p>
...
export default function Home(): ReactNode {
  return (
    <Layout
      title="TsVRC"
      description="TsVRC builds open-source tools for VRChat world and avatar creators.">
      <Hero />
      <TrustBar />
      <Projects />
    </Layout>
