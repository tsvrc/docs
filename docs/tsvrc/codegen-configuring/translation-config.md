...
[`TranslationModule`](./translation-module) for how the generator actually
turns these into generated lookup code, and the
[Translation window](../codegen-internals/ts-translation-window) for the authoring tool built
around this same file format.
