...
files [`TranslationModule`](../codegen-configuring/translation-module) turns into generated
lookup code. It edits the same [`TsTranslationConfig`](../codegen-configuring/translation-config)
...
[`TsLinkedScene`](../codegen-configuring/linked-scene)) `TranslationModule` scans at generate
